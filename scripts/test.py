...
class PrestaShopTest(unittest.TestCase):
    ...
    def fill_cart(self):
        ...
        for url, num in zip(urls, num_products_to_buy):
            ...
            self.driver.get(url)
            time.sleep(5)
            products = self.driver.find_elements(By.XPATH, "//div[@class='js-product product col-xs-6 col-xl-4']")
    ...
    def remove_from_cart(self):
        self.driver.get("https://localhost/prestashop/koszyk?action=show")
        time.sleep(5)
    ...
    def register_and_order(self):
        self.driver.get("https://localhost/prestashop/zamówienie")
        time.sleep(5)
    ...
    def check_status(self, order_id):
        self.driver.get("https://localhost/prestashop/historia-zamowien")
        time.sleep(5)
